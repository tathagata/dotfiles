...
(setq to-install
;; #TODO magit/emacs 24.4 
;;      '(python-mode magit yasnippet jedi auto-complete autopair find-file-in-repository flycheck))
      '(python-mode yasnippet jedi auto-complete autopair find-file-in-repository flycheck))

(mapc 'install-if-needed to-install)

;; #TODO figure out how to work 24.3 with magit or upgrade to 24.4
;; (require 'magit) 
