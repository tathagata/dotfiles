...
alias md='mkdir'
alias cl='clear'
alias dub="du -k ~/* | awk '$1 > 500000' | sort -nr"
alias treeacl='tree -A -C -L 2'

# 2.3) Text and editor commands
alias Em='emacs -nw'     # No X11 windows, Apple Emacs
alias eqq='emacs -nw -Q' # No config and no X11, Apple Emacs
...
# 2.7) Python
alias workon='. bin/activate'

# 2.8) Git
alias glog="git log --pretty=format:'%h %<(20)%an %s'"
